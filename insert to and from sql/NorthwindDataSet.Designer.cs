...
namespace insert_to_and_from_sql.NorthwindDataSetTableAdapters {
...
SELECT CustomerID, CompanyName, ContactName, ContactTitle, Address, City, Region, PostalCode, Country, Phone, Fax FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::insert_to_and_from_sql.Properties.Settings.Default.NorthwindConnectionString;
        }
...
SELECT EmployeeID, LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDate, Address, City, Region, PostalCode, Country, HomePhone, Extension, Photo, Notes, ReportsTo, PhotoPath FROM Employees WHERE (EmployeeID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Employees] SET [LastName] = @LastName, [FirstName] = @FirstName, [T" +
                ...
                "me)) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Ori" +
                "ginal_FirstName)) AND ((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Or" +
                "iginal_Title)) AND ((@IsNull_TitleOfCourtesy = 1 AND [TitleOfCourtesy] IS NULL) " +
                "OR ([TitleOfCourtesy] = @Original_TitleOfCourtesy)) AND ((@IsNull_BirthDate = 1 " +
                "AND [BirthDate] IS NULL) OR ([BirthDate] = @Original_BirthDate)) AND ((@IsNull_H" +
                "ireDate = 1 AND [HireDate] IS NULL) OR ([HireDate] = @Original_HireDate)) AND ((" +
                ...
                "sNull_Region = 1 AND [Region] IS NULL) OR ([Region] = @Original_Region)) AND ((@" +
                "IsNull_PostalCode = 1 AND [PostalCode] IS NULL) OR ([PostalCode] = @Original_Pos" +
                "talCode)) AND ((@IsNull_Country = 1 AND [Country] IS NULL) OR ([Country] = @Orig" +
                "inal_Country)) AND ((@IsNull_HomePhone = 1 AND [HomePhone] IS NULL) OR ([HomePho" +
                "ne] = @Original_HomePhone)) AND ((@IsNull_Extension = 1 AND [Extension] IS NULL)" +
                " OR ([Extension] = @Original_Extension)) AND ((@IsNull_ReportsTo = 1 AND [Report" +
                "sTo] IS NULL) OR ([ReportsTo] = @Original_ReportsTo)) AND ((@IsNull_PhotoPath = " +
                "1 AND [PhotoPath] IS NULL) OR ([PhotoPath] = @Original_PhotoPath)));\r\nSELECT Emp" +
                "loyeeID, LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDate, Addre" +
                "ss, City, Region, PostalCode, Country, HomePhone, Extension, Photo, Notes, Repor" +
                "tsTo, PhotoPath FROM Employees WHERE (EmployeeID = @EmployeeID)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        public virtual int Update(
            ...
            if ((Original_TitleOfCourtesy == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[25].Value = ((string)(Original_TitleOfCourtesy));
            }
            if ((Original_BirthDate.HasValue == true)) {
            ...
            if ((Original_PostalCode == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[37].Value = ((string)(Original_PostalCode));
            }
            if ((Original_Country == null)) {
            ...
            if ((Original_PhotoPath == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[47].Value = ((string)(Original_PhotoPath));
            }
